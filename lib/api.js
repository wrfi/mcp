...
/**
 * Push a new creation.
 * @param {object} opts - { title, content?, contentType?, artifacts?, secure?, unlisted?, password?, apiKey?, generation?, provenance? }
 * @returns {Promise<object>} - { url, shortId, editToken, expiresAt?, ... }
 */
